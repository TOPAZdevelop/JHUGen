...
subroutine amp_VH_real(Mom,mass,helicity,id,amp)
...
! amplitudes w/o HVV or VFF couplings to calculate
  if(id(6).ne.convertLHE(Pho_))then !Z/W/A decays
    ...
    if(id(1).gt.0d0)then!q q~
      ...
      call spinoru2(5,(/Mom(1:4,2),Mom(1:4,1),Mom(1:4,1)+Mom(1:4,2),Mom(1:4,4),Mom(1:4,10)/),Spaa,Spbb,sprod)!!!!!!!!!!to be determined depending on reference momentum
    endif
